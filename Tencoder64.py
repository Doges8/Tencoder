...
t = Label(root, text="Tencoder64 encodes text to bytes using base64, for other methods of encoding, please download a different version of Tencoder", fg="green")
